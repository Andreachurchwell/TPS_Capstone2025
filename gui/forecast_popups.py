...
#     # --- END of for loop for forecast cards above ---

#     # Chart container (AFTER all forecast cards)
#     chart_frame = tk.Frame(popup, bg=bg)
#     chart_frame.pack(fill="both", expand=True, padx=20, pady=10)

#     try:
#         chart_canvas = create_temp_chart(forecast_summary, bg_color=bg)
#         if chart_canvas:
#             chart_widget = chart_canvas.get_tk_widget()
#             chart_widget.pack(in_=chart_frame, fill="both", expand=True)
#     except Exception as e:
#         print("Chart rendering was interrupted or failed:", e)
